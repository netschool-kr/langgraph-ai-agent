...
class PageElementsExtractorNode(BaseNode):
    ...
    def execute(self, state: GraphState) -> GraphState:
        ...
        for elem in elements:
            ...
            # 추가 검토가 필요한 code 삭제 하는 것이 논리상 맞음 -- hsc
...
class ImageEntityExtractorNode(BaseNode):
    ...
    def execute(self, state: GraphState) -> GraphState:
        ...
        return GraphState(extracted_image_entities = extracted_image_entities)
...
class TableEntityExtractorNode(BaseNode):
    ...
    def execute(self, state: GraphState) -> GraphState:
        ...
        return GraphState(extracted_table_entities=extracted_table_entities)
